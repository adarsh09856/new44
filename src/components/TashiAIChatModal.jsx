      ...
      if (q.includes('3bhk') || q.includes('villa') || q.includes('thimphu')) {
        ...
        botResponse = {
          ...
          actionBtn: {
            ...
            action: () => openModal('loan-calculator')
          }
        };
                        ...
                        {msg.recommendedItems.map((item) => (
                          <div
                            ...
                            onClick={() => {
                              ...
                              navigateTo(msg.type === 'vehicle' ? 'vehicles' : 'properties');
                            }}
                          ...
                          >
                            <div className="flex items-center gap-2.5">
                              ...
                              <div>
                                ...
                                <span className="text-[#9e1b27] font-extrabold text-[11px]">{formatCurrency(item.priceNu || item.price)}</span>
                              </div>
                            </div>
