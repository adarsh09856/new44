          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-lg relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-2xl font-black font-display mt-1">245</div>
                <span className="text-[10px] text-blue-200 font-medium">+15 this month</span>
              </div>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-sky-500 to-blue-600 text-white shadow-lg relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-2xl font-black font-display mt-1">320</div>
                <span className="text-[10px] text-sky-200 font-medium">+20 this month</span>
              </div>
              <div className="absolute right-3 bottom-3 opacity-30">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-700 text-white shadow-lg relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-2xl font-black font-display mt-1">4,752</div>
                <span className="text-[10px] text-emerald-200 font-medium">+125 this month</span>
              </div>
              <div className="absolute right-3 bottom-3 opacity-30">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 text-white shadow-lg relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-2xl font-black font-display mt-1">1,248</div>
                <span className="text-[10px] text-amber-200 font-medium">+32 this month</span>
              </div>
              <div className="absolute right-3 bottom-3 opacity-30">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-fuchsia-600 to-pink-600 text-white shadow-lg relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-2xl font-black font-display mt-1">856</div>
                <span className="text-[10px] text-pink-200 font-medium">+18 this month</span>
              </div>
              <div className="absolute right-3 bottom-3 opacity-30">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-700 text-white shadow-lg relative overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="text-2xl font-black font-display mt-1">25,689</div>
                <span className="text-[10px] text-teal-200 font-medium flex items-center gap-0.5">
                  <TrendingUp className="w-2.5 h-2.5" /> +18.4% this month
                </span>
              </div>
              <div className="absolute right-3 bottom-3 opacity-30">
            ...
            <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-3">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between py-1 border-b border-slate-100">
                  ...
                  <span className="font-bold text-slate-800">v20.10 LTS</span>
                </div>
                <div className="flex justify-between py-1 border-b border-slate-100">
                  <span className="text-slate-500">Database</span>
                  <span className="font-bold text-slate-800">PostgreSQL / MySQL 8.0</span>
                </div>
                <div>
                  <div className="flex justify-between text-[11px] mb-1">
                    <span className="text-slate-500">Storage Usage</span>
                    <span className="font-bold text-slate-800">45.6 GB / 200 GB</span>
                  </div>
                  <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                    <div className="w-[23%] h-full bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full"></div>
                  </div>
                </div>
                <div className="flex justify-between pt-1">
                  <span className="text-slate-500">Cache Status</span>
                  <span className="font-bold text-emerald-600">Activated</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-3">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="w-16 h-16 rounded-full border-4 border-emerald-500 flex flex-col items-center justify-center bg-emerald-50 text-emerald-800 flex-shrink-0">
                  <span className="font-display font-black text-lg leading-none">85</span>
