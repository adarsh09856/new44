...
import { X, Lock, Mail, User, Phone, ShieldCheck, Check, Loader2 } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-display font-bold text-lg text-white">
                {isRegister ? 'Join Jigme Real Estate' : 'Sign In to Account'}
              </h3>
              <p className="text-xs text-stone-400">
                {isRegister ? 'Create your Bhutan property & vehicle account' : 'Enter your registered credentials to access your dashboard'}
              </p>
            </div>
          </div>
        </div>
